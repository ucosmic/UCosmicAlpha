...
{
    internal class GenerateRandomSecret : IDefineQuery<string>
    {
        internal GenerateRandomSecret(int minimumLength, int maximumLength)
        {
            if (minimumLength < 1)
        ...
        internal GenerateRandomSecret(int exactLength)
    ...
    internal class HandleGenerateRandomSecretQuery
    {
        internal static string Handle(GenerateRandomSecret query)
        {
