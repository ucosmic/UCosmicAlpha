...
namespace UCosmic.Domain.Identity
{
    ...
    {
        //public SAMLProcessor SamlResponse { get; set; }
    ...
    //        string email = samlResponse.EduPersonPrincipalName;
    //        // when saml user does not exist, search for person
    //        if (user == null)
    //        {
    //            if (email == null)
    //            {
    //                email = samlResponse.SubjectNameID;
    //            }
    //            if (email.IndexOf("@") == -1)
    //            {
    //                email += establishment.EmailDomains.FirstOrDefault().Value;
    //            }
    //            samlResponse.Mail = email;
    ...
    //        var subjectNameId = samlResponse.SubjectNameID;
    ...
    //        //var newSamlMails = samlResponse.Mail ?? "";
    ...
    //            _createEmailAddress.Handle(new CreateEmailAddress(email, user.Person)
    //            {
    //                IsDefault = true,
    //                IsConfirmed = true,
    //                NoCommit = true,
    ...
    //            user.Name = email;
    //        }
    //        if (user.Person.DisplayName == null)
    //        {
    //            user.Person.DisplayName = email;
    //        }
    //        if (user.TenantId == null)
    //        {
    //            user.TenantId = establishment.RevisionId;
    //            user.Tenant = establishment;
    //        }
    ...
    //    private Establishment GetTrustedIssuingEstablishment(SAMLProcessor samlResponse)
    //    {
    ...
    //    private static void VerifySignature(SAMLProcessor response)
    //    {
    ...
    //    private User GetUserByEduPersonTargetedId(SAMLProcessor samlResponse)
    //    {
    ...
    //    private User GetUserByName(SAMLProcessor samlResponse)
    //    {
    //        var user = _entities.Get<User>()
    //            .EagerLoad(_entities, _loadUser)
    ...
    //    private Person GetPerson(SAMLProcessor samlResponse)
    //    {
    //        Person person = null;

    //        // first, look up person by mail attribute (if present)
    //        var mail = samlResponse.Mail;
    ...
    //            person = new Person
    //            {
    //                DisplayName = samlResponse.FirstName ??
    //                            samlResponse.LastName ??
    //                            samlResponse.EduPersonPrincipalName,
    //                FirstName = samlResponse.FirstName,
    //                LastName = samlResponse.LastName,
    //            };
    //        }
