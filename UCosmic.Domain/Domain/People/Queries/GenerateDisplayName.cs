...
{
    public class GenerateDisplayName : IDefineQuery<string>
    {
    ...
    public class HandleGenerateDisplayNameQuery : IHandleQueries<GenerateDisplayName, string>
    {
        public string Handle(GenerateDisplayName query)
        {
