...
//                    //{
//                    var data = _queryProcessor.Execute(new UsfDepartments(new UsfFacultyProfileService(integration)));
//                    Import(data);
//                    //}
//                    //else
//                    //{
...
//        {
//            _usf = _entities.Get<Establishment>().SingleOrDefault(e => e.WebsiteUrl == "www.usf.edu");
...
//                        VerticalRank = _campusOrder.ContainsKey(officialName) ? _campusOrder[officialName] : null,
//                    };
...
//        public void Import(UsfDepartmentsData json)
//        {
//            var record = new Record
//            {
//                LastActivityDate = json.LastUpdate,
//                Departments = json.Departments.Select(x => new DepartmentRecord
//                {
//                    College = x.CollegeName,
//                    Department = x.DepartmentName,
//                    Institution = x.CampusName,
