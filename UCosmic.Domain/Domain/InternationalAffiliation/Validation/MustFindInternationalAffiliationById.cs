...
{
    public class MustFindInternationalAffiliationById : PropertyValidator
    {
        public const string FailMessageFormat = "Affiliation with id '{0}' does not exist.";

        private readonly IQueryEntities _entities;

        internal MustFindInternationalAffiliationById(IQueryEntities entities)
        ...
        protected override bool IsValid(PropertyValidatorContext context)
        {
            ...
            var entity = _entities.Query<InternationalAffiliation>()
    ...
    public static class MustFindAffiliationByIdExtensions
    {
        ...
        {
            return ruleBuilder.SetValidator(new MustFindInternationalAffiliationById(entities));
        }
    }
}
