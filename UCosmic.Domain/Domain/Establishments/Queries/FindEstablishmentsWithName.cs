...
{
    public class EstablishmentsWithName : BaseEntitiesQuery<Establishment>, IDefineQuery<Establishment[]>
    {
    ...
    public class HandleEstablishmentsWithNameQuery : IHandleQueries<EstablishmentsWithName, Establishment[]>
    {
        private readonly IQueryEntities _entities;

        public HandleEstablishmentsWithNameQuery(IQueryEntities entities)
        {
            _entities = entities;
        }

        public Establishment[] Handle(EstablishmentsWithName query)
        {
