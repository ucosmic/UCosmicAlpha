...
{
    public class UpdateSamlSignOnMetadata
    {
        public int EstablishmentId { get; set; }
    }

    public class HandleUpdateSamlSignOnMetadataCommand : IHandleCommands<UpdateSamlSignOnMetadata>
    {
        ...
        public HandleUpdateSamlSignOnMetadataCommand(ICommandEntities entities
        ...
        public void Handle(UpdateSamlSignOnMetadata command)
        {
