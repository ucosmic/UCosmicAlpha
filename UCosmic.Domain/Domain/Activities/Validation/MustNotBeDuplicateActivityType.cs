...
namespace UCosmic.Domain.Activities
{
    ...
    {
        private const string FailMessageFormat = "Activity with id '{ActivityId}' is already associated with activity type id '{TypeId}'.";
        ...
        protected override bool IsValid(PropertyValidatorContext context)
        {
            ...
            context.MessageFormatter.AppendArgument("TypeId", context.PropertyValue);
            return false;
        }
    }
