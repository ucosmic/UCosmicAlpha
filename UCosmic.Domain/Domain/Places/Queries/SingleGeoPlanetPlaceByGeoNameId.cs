...
namespace UCosmic.Domain.Places
{
    ...
    public class HandleSingleGeoPlanetPlaceByGeoNameIdQuery : IHandleQueries<SingleGeoPlanetPlaceByGeoNameId, GeoPlanetPlace>
    {
        private readonly IProcessQueries _queryProcessor;
        private readonly IContainGeoPlanet _geoPlanet;

        public HandleSingleGeoPlanetPlaceByGeoNameIdQuery(IProcessQueries queryProcessor, IContainGeoPlanet geoPlanet)
        {
