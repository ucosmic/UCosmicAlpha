...
{
    public class CreateAgreementSettings
    {
        public CreateAgreementSettings() { }

        public CreateAgreementSettings(IPrincipal principal, int agreementId, int contactId)
        {
        ...
        internal CreateAgreementSettings(IPrincipal principal, AgreementContact contact)
        {
            if (principal == null) throw new ArgumentNullException("principal");
            Principal = principal;
            Contact = contact;
    ...
    public class ValidateCreateAgreementSettingsCommand : AbstractValidator<CreateAgreementSettings>
    {
        public ValidateCreateAgreementSettingsCommand(IQueryEntities entities, IProcessQueries queryProcessor)
        {
    ...
    public class HandleCreateAgreementSettingsCommand : IHandleCommands<CreateAgreementSettings>
    {
        private readonly ICommandEntities _entities;
        private readonly IUnitOfWork _unitOfWork;

        public HandleCreateAgreementSettingsCommand(ICommandEntities entities
        ...
        public void Handle(CreateAgreementSettings command)
        {
