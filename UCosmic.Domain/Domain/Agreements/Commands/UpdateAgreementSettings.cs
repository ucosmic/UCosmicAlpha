...
{
    public class UpdateAgreementSettings
    {
        public UpdateAgreementSettings(IPrincipal principal, int agreementId)
        {
    ...
    public class ValidateUpdateAgreementSettingsCommand : AbstractValidator<UpdateAgreementSettings>
    {
        public ValidateUpdateAgreementSettingsCommand(IQueryEntities entities, IProcessQueries queryProcessor)
        {
    ...
    public class HandleUpdateAgreementSettingsCommand : IHandleCommands<UpdateAgreementSettings>
    {
        private readonly ICommandEntities _entities;
        private readonly IUnitOfWork _unitOfWork;
       
        public HandleUpdateAgreementSettingsCommand(ICommandEntities entities
        ...
        public void Handle(UpdateAgreementSettings command)
        {
