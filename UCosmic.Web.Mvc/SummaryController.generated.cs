...
namespace UCosmic.Web.Mvc.Controllers
{
    public partial class SummaryController
    {
        ...
        protected SummaryController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Summary";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_SummaryController : UCosmic.Web.Mvc.Controllers.SummaryController
    {
        public T4MVC_SummaryController() : base(Dummy.Instance) { }
