    ...
    public static class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/employees/summary").Include(
                ...
                "~/scripts/viewmodels/activities/Summary_Server.js",
                "~/scripts/viewmodels/activities/Summary.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/people/degrees/search").Include(
                "~/scripts/viewmodels/establishments/Server.js",
                "~/scripts/app/DataCacher.js",
