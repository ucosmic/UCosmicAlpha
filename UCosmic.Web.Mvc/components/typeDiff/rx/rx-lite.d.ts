...
declare module Rx {
	...
	interface ObservableStatic {
		...
		*/
        ...
        combineLatest<T, T2, T3, T4, T5, T6, TResult>(first: Observable<T>, second: Observable<T2>, third: Observable<T3>, fourth: Observable<T4>, fifth: Observable<T5>, sixth: Observable<T6>, resultSelector: (v1: T, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6) => TResult): Observable<TResult>;
        combineLatest<T, T2, T3, T4, T5, T6, T7, T8, T9, TResult>(first: Observable<T>, second: Observable<T2>, third: Observable<T3>, fourth: Observable<T4>, fifth: Observable<T5>, sixth: Observable<T6>, sevenyh: Observable<T7>, eighth: Observable<T8>, ninth: Observable<T9>, resultSelector: (v1: T, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6, v7: T7, v8: T8, v9: T9) => TResult): Observable<TResult>;
