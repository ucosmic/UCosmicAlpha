...
Polymer('polymer-inputs-rtf', {
    ...
    inputChange: function () {
        var options = { isEmail: this.isEmail, value: this.$.input.value, name: this.name, isRequired: this.isRequired, 
            valueCompared: this.comparedValue, nameCompared: this.nameCompared, min: this.min }, 
    ...
    domReady: function() {
        ...
        $.getScript(url, () => {
            ...
            //$.getScript("components/form/utilities/rtf/rtf.colorPicker.js")
            this.initTinymce();
        });
    ...
    initTinymce: function () {
        ...
        $(this.$.input).wysiwyg({
            ...
            this.myValue = $(this.$.input).wysiwyg("getContent");
        })
    },
});