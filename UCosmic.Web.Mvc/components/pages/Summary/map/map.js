...
Polymer('is-page-summary-map', {
    ...
    mouseX: function (evt) {
        ...
        if (evt.pageX)
            ...
            var arr = _.values(evt);
            var pageX = 0;
            arr.forEach(function (value, index, test) {
    ...
    setupMapFilters: function () {
        ...
        map.data.addListener('click', function (event) {
            ...
            element.content = "<b>" + event.feature.getProperty('name') + "</b><br /><a on-click={{click_link}} href='/summary/report/#!/" + event.feature.getProperty('iso_a2') + "'>Total: " + event.feature.getProperty('total_count') + "</a>"
                + "<br /><a on-click={{click_link}} href='/" + _this.style_domain + "/agreements/#/table/country/" + event.feature.getProperty('iso_a2') + "/type/any/sort/start-desc/size/10/page/1/keyword/*none*/ancestorId/" + _this.new_tenant_id + "'>Agreements: " + event.feature.getProperty('agreement_count') + "</a>"
                + "<br /><a on-click={{click_link}} href='/" + _this.style_domain + "/employees/table/?placeIds=" + country.id + "&placeNames=" + country.name + "&ancestorId=" + _this.new_tenant_id + "'>Activities: " + event.feature.getProperty('activity_count') + "</a>"
