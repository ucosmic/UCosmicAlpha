...
Polymer({
    ...
    uCosmicStudentAffiliationId: number;
    uCosmicForeignAffiliationId: number;*/
        ...
        //            program: s1.program, program_name: s1.program_name,  establishment: s2.uCosmicAffiliationId, student_establishment: s2.uCosmicStudentAffiliationId,
    ...
    set_fire_students_mobilities_join: function (_this) {
        ...
        norm.select({ key: 'Mobilities.student', alias: 'mobility_student' }, { key: 'Mobilities.level', alias: 'mobility_level' }, { key: 'Mobilities.term', alias: 'mobility_term' }
            ...
            , { key: 'Mobilities.foreign_establishmente', alias: 'mobility_foreign_establishmente' }, { key: 'Mobilities.student_establishment', alias: 'mobility_student_establishment' }
            , { key: 'Students.external_id', alias: 'student_external_id' }, { key: 'Students.establishment', alias: 'student_establishment' }
