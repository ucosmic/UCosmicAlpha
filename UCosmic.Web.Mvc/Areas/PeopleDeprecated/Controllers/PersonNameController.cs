...
using UCosmic.Web.Mvc.Areas.PeopleDeprecated.Models;
...
namespace UCosmic.Web.Mvc.Areas.PeopleDeprecated.Controllers
{
    ...
    //[Authenticate]
    public partial class PersonNameController : Controller
    {
        ...
        private static IEnumerable GetAutoCompleteOptions(string term, ICollection<string> data, IEnumerable<string> defaults)
        {
            ...
            // mix in the data
            if (data != null && data.Any()) merged.AddRange(data);
