...
namespace UCosmic.Web.Mvc.Areas.IdentityDeprecated.Controllers
{
    public partial class UpdateAffiliationController
    {
        ...
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Put);
        }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public UpdateAffiliationController Actions { get { return MVC.IdentityDeprecated.UpdateAffiliation; } }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_UpdateAffiliationController : UCosmic.Web.Mvc.Areas.IdentityDeprecated.Controllers.UpdateAffiliationController
    {
        ...
        public override System.Web.Mvc.ActionResult Put(UCosmic.Web.Mvc.Areas.IdentityDeprecated.Models.UpdateAffiliationForm model)
        {
