...
namespace UCosmic.Web.Mvc.Areas.ActivitiesDeprecated.Controllers
{
    public partial class ActivityIndexController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActivityIndexController Actions { get { return MVC.ActivitiesDeprecated.ActivityIndex; } }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_ActivityIndexController : UCosmic.Web.Mvc.Areas.ActivitiesDeprecated.Controllers.ActivityIndexController
    {
        public T4MVC_ActivityIndexController() : base(Dummy.Instance) { }

        public override System.Web.Mvc.RedirectToRouteResult Get()
        {
            var callInfo = new T4MVC_System_Web_Mvc_RedirectToRouteResult(Area, Name, ActionNames.Get);
            return callInfo;
        }
