...
namespace UCosmic.Web.Mvc.Areas.ActivitiesDeprecated.Controllers
{
    public partial class ActivityFormController
    {
        ...
        {
            return new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.Put);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.JsonResult Draft()
        {
            return new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.Draft);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActivityFormController Actions { get { return MVC.ActivitiesDeprecated.ActivityForm; } }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_ActivityFormController : UCosmic.Web.Mvc.Areas.ActivitiesDeprecated.Controllers.ActivityFormController
    {
        ...
        public override System.Web.Mvc.JsonResult Put(int number, UCosmic.Web.Mvc.Areas.ActivitiesDeprecated.Models.ActivityForm model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.Put);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "number", number);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            return callInfo;
        }

        public override System.Web.Mvc.JsonResult Draft(int number, UCosmic.Web.Mvc.Areas.ActivitiesDeprecated.Models.ActivityForm model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.Draft);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "number", number);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            return callInfo;
        }
