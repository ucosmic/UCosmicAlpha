<fab_close>
    ...
    <div id="fab_close_container">
        <div id="fab_close_button">
            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" style="pointer-events: none; display: inline-block; width: 2em; height: 2em;fill:white; ">
                <g>
