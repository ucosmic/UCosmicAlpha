<header_toolbar>
    ...
    <div id="header_toolbar" class="layout horizontal start-justified">
        ...
        <div id="header_toolbar_menu_container" class="layout horizontal start-justified">
            ...
            <span class="toolbar_item highlight-text" onclick="{toggle_login}" show="{(!ucosmic.user || !ucosmic.user.email) && is_login_loaded}">
                Sign Up/In
            </span>
            <span class="toolbar_icon" onclick="{toggle_account}" show="{ucosmic.user && ucosmic.user.email}">
                <span>
                    <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet"
                         style="pointer-events: none; display: block; width: 100%; height: 100%;">
                        <g>
                ...
                <a href="/index2.html#tennant" class="toolbar_item highlight-text hide_small" show="{ucosmic.user && ucosmic.user.email}">
                    tennant
                </a>
...
//                                RiotControl.trigger('add_page', 'tennant');
                ...
                RiotControl.trigger('firebase_loaded', ucosmic.fire_ref);// may not need this
