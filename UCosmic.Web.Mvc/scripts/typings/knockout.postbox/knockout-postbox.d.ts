...
interface KnockoutObservableArray {
    subscribeTo: (topic: string, useLastPublishedValueToInitialize?: bool, transform?: (val: Array ) => Array ) => KnockoutObservableArray;
    unsubscribeFrom: (topic: string) => KnockoutObservableArray ;
    publishOn: (topic: string, skipInitialPublish?: bool, equalityComparer?: (newValue: Array , oldValue: Array ) => bool) => KnockoutObservableArray ;
    stopPublishingOn: (topic: string) => KnockoutObservableArray ;
    syncWith: (topic: string, initializeWithLatestValue?: bool, skipInitialPublish?: bool, equalityComparer?: (newValue: Array , oldValue: Array ) => bool) => KnockoutObservableArray ;
}
