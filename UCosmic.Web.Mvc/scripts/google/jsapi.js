...
if ( !window['google']['loader'] ) {
    ...
    (function() {
        ...
        function l(a, b) { return a.load = b }
        ...
        function D(a) { return a in E ? E[a] : E[a] = -1 != navigator.userAgent[C]()[r](a) }
        ...
        function G(a, b, c) {
            ...
            return function() {
                var c = e.concat(Array[x].slice.call(arguments));
                return a.apply(b, c)
            }
        }
        ...
        function H(a) {
            a = Error(a);
            a.toString = function() { return this.message };
            return a
        }
        ...
        google.T = function(a, b) { b ? (0 == O[w] && (P(g, "load", Q), !D("msie") && !D("safari") && !D("konqueror") && D("mozilla") || g.opera ? g.addEventListener("DOMContentLoaded", Q, !1) : D("msie") ? h.write("<script defer onreadystatechange='google.loader.domReady()' src=//:>\x3c/script>") : (D("safari") || D("konqueror")) && g[y](S, 10)), O[m](a)) : P(g, "load", a) };
        ...
        function aa(a) { return function() { for (var b = 0; b < a[w]; b++) a[b]() } }
        ...
        function S() { ba[h.readyState] ? Q() : 0 < O[w] && g[y](S, 10) }
        ...
        google[z].Q = function(a) { N = a };
        K("google.loader.rfm", google[z].Q);
        google[z].S = function(a) { for (var b in a) "string" == typeof b && (b && ":" == b[q](0) && !M[b]) && (M[b] = new T(b[A](1), a[b])) };
        ...
        google[z].loaded = function(a) { M[":" + a.module].l(a) };
        K("google.loader.loaded", google[z].loaded);
        google[z].O = function() { return "qid=" + ((new Date)[v]().toString(16) + Math.floor(1E7 * Math.random()).toString(16)) };
        ...
        U[x].m = function(a, b) { return 0 == this.t(b)[w] };
        U[x].s = function() { return !0 };
        ...
        W[x].C = function(a) { this.q[":" + a] && (this.q[":" + a] = !1, this.r--, 0 == this.r && g[y](this.F, 0)) };
        ...
        V[x].m = function(a, b) { return b && null != b.callback ? this.u : this.h };
        V[x].l = function() {
            this.u = !0;
            for (var a = 0; a < this.k[w]; a++) g[y](this.k[a], 0);
            this.k = []
        };
        var Y = function(a, b) { return a.string ? d(a.string) + "=" + d(b) : a.regex ? b[n](/(^.*$)/, a.regex) : "" };
        V[x].g = function(a, b) { return this.G(this.w(a), a, b) };
        ...
        V[x].s = function(a) { return this.w(a).deferred };
        V[x].w = function(a) {
            if (this.p)
        ...
        T[x].s = function() { return !1 };
        var ca = !1, Z = [], da = (new Date)[v](), fa = function() { ca || (P(g, "unload", ea), ca = !0) }, ga = function(a, b) {
            fa();
        ...
        }, X = function(a, b, c) { c ? ga([a], [b]) : (fa(), Z[m]("r" + Z[w] + "=" + d(a + (b ? "|" + b : ""))), g[y](ea, 5 < Z[w] ? 0 : 15E3)) }, ea = function() {
            if (Z[w]) {
                var a =
                    google[z][t];
            ...
            var b = new Image, c = $.H++;
            $.A[c] = b;
            b.onload = b.onerror = function() { delete $.A[c] };
            b.src = a;
            b = null
        };
        $.A = {};
