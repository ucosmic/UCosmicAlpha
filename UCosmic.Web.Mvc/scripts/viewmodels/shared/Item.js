    ...
    (function (Shared) {
        ...
        var Item = (function () {
            function Item(id) {
                ...
                this.parentSearch = new Shared.Search(false);
                this.sammy = Sammy();
                ...
                this.location = new Shared.Location(this.id);
            ...
            Item.prototype.addName = function () {
                var apiModel = new Shared.ServerNameApiModel(this.id);
                if(this.names().length === 0) {
                    apiModel.isOfficialName = true;
                }
                var newName = new Shared.Name(apiModel, this);
            ...
            Item.prototype._initNamesComputeds = function () {
                ...
                this._namesMapping = {
                    create: function (options) {
                        return new Shared.Name(options.data, _this);
                    }
                };
            ...
            Item.prototype.addUrl = function () {
                var apiModel = new Shared.ServerUrlApiModel(this.id);
                if(this.urls().length === 0) {
                    apiModel.isOfficialUrl = true;
                }
                var newUrl = new Shared.Url(apiModel, this);
            ...
            Item.prototype._initUrlsComputeds = function () {
                ...
                this._urlsMapping = {
                    create: function (options) {
                        return new Shared.Url(options.data, _this);
                    }
                };
                    ...
                    if(!newValue) {
                        ...
                        $.get(url, {
                            ...
                            if(response && response.items && response.items.length) {
                                ...
                                _this.parentEstablishment(new Shared.SearchResult(parent, _this.parentSearch));
                            }
                        });
                    }
                });
        ...
        Shared.Item = Item;        
    })(ViewModels.Shared || (ViewModels.Shared = {}));
    var Shared = ViewModels.Shared;
