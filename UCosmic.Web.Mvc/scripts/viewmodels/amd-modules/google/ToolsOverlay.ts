...
export interface KnockoutObservableGoogleMapsToolsOverlay extends KnockoutObservableBase {
    (): ToolsOverlay;
    (value: ToolsOverlay): void;

    subscribe(callback: (newValue: ToolsOverlay) => void, target?:any, topic?: string): KnockoutSubscription;
    notifySubscribers(valueToWrite: ToolsOverlay, topic?: string);
}
