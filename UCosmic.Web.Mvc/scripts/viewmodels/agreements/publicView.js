...
(function (Agreements) {
    ...
    (function (ViewModels) {
        var PublicView = (function () {
            ...
            PublicView.prototype.updateKendoDialog = function (windowWidth) {
                $(".k-window").css({
                    left: (windowWidth / 2 - ($(".k-window").width() / 2) + 10)
                });
            };

            PublicView.prototype.bindjQueryKendo = function (result) {
                var self = this;
            ...
            PublicView.prototype.getSettings = function () {
                var _this = this;
            ...
            PublicView.prototype.saveUpdateAgreement = function () {
                var _this = this;
                var offset;
