//import RootViewModelsSpike = ViewModels;
 ...
 module People.ViewModels {
     ...
     export class AffiliationSpike implements KoModels.Affiliation, KnockoutValidationGroup {
         ...
         constructor(owner: ProfileSpike, data: ApiModels.Affiliation);
         constructor(owner: ProfileSpike, personId: number);
         constructor(owner: ProfileSpike, dataOrPersonId: any) {
             this.owner = owner;
