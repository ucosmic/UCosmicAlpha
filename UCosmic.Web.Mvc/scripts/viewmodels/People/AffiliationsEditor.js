...
(function (People) {
    (function (ViewModels) {
        ...
        var AffiliationsEditor = (function () {
            function AffiliationsEditor(personId) {
                var _this = this;
            ...
            AffiliationsEditor.prototype.facultyRankAutoUpdate = function (data) {
            ...
            AffiliationsEditor.prototype.affiliatedEstablishmentsAutoUpdate = function (data) {
                if (data.value() == undefined) {
                    return null;
                }
                var match = ko.utils.arrayFirst(data.options(), function (item) {
            ...
            AffiliationsEditor.prototype.addAffiliation = function (me) {
            ...
            AffiliationsEditor.prototype.startEditingAffiliations = function () {
                this.$edit_affiliations_dialog.data("kendoWindow").open().title("Affiliations");
            };

            AffiliationsEditor.prototype.saveAffiliations = function () {
            ...
            return AffiliationsEditor;
        })();
        ViewModels.AffiliationsEditor = AffiliationsEditor;
