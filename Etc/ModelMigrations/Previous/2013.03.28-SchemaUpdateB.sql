...
GO
PRINT N'Creating [Languages].[Language].[UX_Language_TwoLetterIsoCode]...';


GO
CREATE UNIQUE NONCLUSTERED INDEX [UX_Language_TwoLetterIsoCode]
    ON [Languages].[Language]([TwoLetterIsoCode] ASC);
...
GO
PRINT N'Creating [Places].[GeoNamesToponym].[IX_GeoNamesToponym_PlaceId]...';


GO
CREATE NONCLUSTERED INDEX [IX_GeoNamesToponym_PlaceId]
    ON [Places].[GeoNamesToponym]([PlaceId] ASC);
...
GO
PRINT N'Creating [Places].[GeoPlanetPlace].[IX_GeoPlanetPlace_PlaceId]...';


GO
CREATE NONCLUSTERED INDEX [IX_GeoPlanetPlace_PlaceId]
    ON [Places].[GeoPlanetPlace]([PlaceId] ASC);


GO
PRINT N'Creating [Places].[GeoPlanetPlace].[IX_GeoPlanetPlace_PlaceId_TypeCode_WoeId]...';


GO
CREATE NONCLUSTERED INDEX [IX_GeoPlanetPlace_PlaceId_TypeCode_WoeId]
    ON [Places].[GeoPlanetPlace]([PlaceId] ASC, [TypeCode] ASC, [WoeId] ASC);


GO
PRINT N'Creating [Places].[GeoPlanetPlace].[IX_GeoPlanetPlace_PlaceId_WoeId_TypeCode]...';


GO
CREATE NONCLUSTERED INDEX [IX_GeoPlanetPlace_PlaceId_WoeId_TypeCode]
    ON [Places].[GeoPlanetPlace]([PlaceId] ASC, [WoeId] ASC, [TypeCode] ASC)
    INCLUDE([ParentWoeId]);
...
GO
PRINT N'Creating [Places].[PlaceName].[IX_PlaceName_AsciiEquivalent]...';


GO
CREATE NONCLUSTERED INDEX [IX_PlaceName_AsciiEquivalent]
    ON [Places].[PlaceName]([AsciiEquivalent] ASC, [NameForPlaceId] ASC, [TranslationToLanguageId] ASC);


GO
PRINT N'Creating [Places].[PlaceName].[IX_PlaceName_NameForPlaceId_TranslationToLanguageId_Text_AsciiEquivalent]...';


GO
CREATE NONCLUSTERED INDEX [IX_PlaceName_NameForPlaceId_TranslationToLanguageId_Text_AsciiEquivalent]
    ON [Places].[PlaceName]([NameForPlaceId] ASC, [TranslationToLanguageId] ASC, [Text] ASC, [AsciiEquivalent] ASC)
    INCLUDE([RevisionId], [TranslationToHint], [IsPreferredTranslation], [EntityId], [CreatedOnUtc], [CreatedByPrincipal], [UpdatedOnUtc], [UpdatedByPrincipal], [Version], [IsCurrent], [IsArchived], [IsDeleted]);


GO
PRINT N'Creating [Places].[PlaceName].[IX_PlaceName_Text]...';


GO
CREATE NONCLUSTERED INDEX [IX_PlaceName_Text]
    ON [Places].[PlaceName]([Text] ASC);


GO
PRINT N'Creating [Places].[PlaceName].[IX_PlaceName_TranslationToLanguage_AsciiEquivalent]...';


GO
CREATE NONCLUSTERED INDEX [IX_PlaceName_TranslationToLanguage_AsciiEquivalent]
    ON [Places].[PlaceName]([TranslationToLanguageId] ASC, [AsciiEquivalent] ASC);


GO
PRINT N'Creating [Places].[PlaceName].[IX_PlaceName_TranslationToLanguage_Text]...';


GO
CREATE NONCLUSTERED INDEX [IX_PlaceName_TranslationToLanguage_Text]
    ON [Places].[PlaceName]([TranslationToLanguageId] ASC, [Text] ASC);
...
GO
PRINT N'Creating [Places].[PlaceNode].[IX_PlaceNode_OffspringId_AncestorId]...';


GO
CREATE NONCLUSTERED INDEX [IX_PlaceNode_OffspringId_AncestorId]
    ON [Places].[PlaceNode]([OffspringId] ASC, [AncestorId] ASC)
    INCLUDE([Separation]);
...
GO
PRINT N'Creating [ActivitiesV2].[ActivityDocument].[IX_ProxyImageId]...';


GO
CREATE NONCLUSTERED INDEX [IX_ProxyImageId]
    ON [ActivitiesV2].[ActivityDocument]([ProxyImageId] ASC);


GO
PRINT N'Creating [ActivitiesV2].[ActivityLocation].[IX_ActivityValuesId]...';
...
GO
PRINT N'Creating [ActivitiesV2].[ActivityLocation].[IX_PlaceId]...';


GO
CREATE NONCLUSTERED INDEX [IX_PlaceId]
    ON [ActivitiesV2].[ActivityLocation]([PlaceId] ASC);
...
GO
PRINT N'Creating [Representatives].[RepModuleSettings].[IX_OwnerId]...';


GO
CREATE NONCLUSTERED INDEX [IX_OwnerId]
    ON [Representatives].[RepModuleSettings]([OwnerId] ASC);
...
GO
PRINT N'Creating [Places].[GeoNamesToponym].[ST_GeoNamesToponym_PlaceId_GeoNameId]...';


GO
CREATE STATISTICS [ST_GeoNamesToponym_PlaceId_GeoNameId]
    ON [Places].[GeoNamesToponym]([PlaceId], [GeoNameId]);


GO
PRINT N'Creating [Places].[GeoPlanetPlace].[ST_GeoPlanetPlace_TypeCode_PlaceId_WoeId]...';


GO
CREATE STATISTICS [ST_GeoPlanetPlace_TypeCode_PlaceId_WoeId]
    ON [Places].[GeoPlanetPlace]([TypeCode], [PlaceId], [WoeId]);


GO
PRINT N'Creating [Places].[GeoPlanetPlace].[ST_GeoPlanetPlace_WoeId_EnglishName_Uri_LatLng_Boxing_Ranks_Etc_1]...';


GO
CREATE STATISTICS [ST_GeoPlanetPlace_WoeId_EnglishName_Uri_LatLng_Boxing_Ranks_Etc_1]
    ON [Places].[GeoPlanetPlace]([WoeId], [EnglishName], [Uri], [Latitude], [Longitude], [NorthLatitude], [EastLongitude], [SouthLatitude], [WestLongitude], [AreaRank], [PopulationRank], [Postal], [CountryCode], [CountryType]);


GO
PRINT N'Creating [Places].[GeoPlanetPlace].[ST_GeoPlanetPlace_WoeId_ParentWoeId]...';


GO
CREATE STATISTICS [ST_GeoPlanetPlace_WoeId_ParentWoeId]
    ON [Places].[GeoPlanetPlace]([WoeId], [ParentWoeId]);


GO
PRINT N'Creating [Places].[GeoPlanetPlace].[ST_GeoPlanetPlace_WoeId_ParentWoeId_TypeCode_EnglishName_Etc_1]...';


GO
CREATE STATISTICS [ST_GeoPlanetPlace_WoeId_ParentWoeId_TypeCode_EnglishName_Etc_1]
    ON [Places].[GeoPlanetPlace]([PlaceId], [WoeId], [ParentWoeId], [TypeCode], [EnglishName], [Uri], [Latitude], [Longitude], [NorthLatitude], [EastLongitude], [SouthLatitude], [WestLongitude], [AreaRank], [PopulationRank], [Postal], [CountryCode]);


GO
PRINT N'Creating [Places].[GeoPlanetPlace].[ST_GeoPlanetPlace_WoeId_TypeCode_PlaceId_EnglishName_Uri_LatLng_Boxing_Ranks_Etc_1]...';


GO
CREATE STATISTICS [ST_GeoPlanetPlace_WoeId_TypeCode_PlaceId_EnglishName_Uri_LatLng_Boxing_Ranks_Etc_1]
    ON [Places].[GeoPlanetPlace]([WoeId], [TypeCode], [PlaceId], [EnglishName], [Uri], [Latitude], [Longitude], [NorthLatitude], [EastLongitude], [SouthLatitude], [WestLongitude], [AreaRank], [PopulationRank], [Postal], [CountryCode], [CountryType]);
...
GO
PRINT N'Creating [Places].[PlaceName].[ST_PlaceName_AsciiEquivalent_Text_NameForPlaceId]...';


GO
CREATE STATISTICS [ST_PlaceName_AsciiEquivalent_Text_NameForPlaceId]
    ON [Places].[PlaceName]([AsciiEquivalent], [Text], [NameForPlaceId]);


GO
PRINT N'Creating [Places].[PlaceName].[ST_PlaceName_AsciiEquivalent_Text_TranslationToLanguageId_NameForPlaceId]...';


GO
CREATE STATISTICS [ST_PlaceName_AsciiEquivalent_Text_TranslationToLanguageId_NameForPlaceId]
    ON [Places].[PlaceName]([AsciiEquivalent], [Text], [TranslationToLanguageId], [NameForPlaceId]);


GO
PRINT N'Creating [Places].[PlaceName].[ST_PlaceName_NameForPlaceId_AsciiEquivalent]...';


GO
CREATE STATISTICS [ST_PlaceName_NameForPlaceId_AsciiEquivalent]
    ON [Places].[PlaceName]([NameForPlaceId], [AsciiEquivalent]);


GO
PRINT N'Creating [Places].[PlaceName].[ST_PlaceName_RevisionId_TranslationToLanguageId]...';


GO
CREATE STATISTICS [ST_PlaceName_RevisionId_TranslationToLanguageId]
    ON [Places].[PlaceName]([RevisionId], [TranslationToLanguageId]);


GO
PRINT N'Creating [Places].[PlaceName].[ST_PlaceName_Text_NameForPlaceId]...';


GO
CREATE STATISTICS [ST_PlaceName_Text_NameForPlaceId]
    ON [Places].[PlaceName]([Text], [NameForPlaceId]);


GO
PRINT N'Creating [Places].[PlaceName].[ST_PlaceName_TranslationToLanguageId_AsciiEquivalent]...';


GO
CREATE STATISTICS [ST_PlaceName_TranslationToLanguageId_AsciiEquivalent]
    ON [Places].[PlaceName]([TranslationToLanguageId], [AsciiEquivalent]);
