...
ALTER TABLE [HomeSection].[HomeSection] WITH NOCHECK
    ADD CONSTRAINT [FK_HomeSection.HomeSection_Establishments.Establishment_EstablishmentId] FOREIGN KEY ([EstablishmentId]) REFERENCES [Establishments].[Establishment] ([RevisionId]) ON DELETE CASCADE;
...
GO
ALTER TABLE [HomeSection].[HomeSection] WITH NOCHECK
    ADD CONSTRAINT [FK_HomeSection.HomeSection_Files.ExternalFile_PhotoId] FOREIGN KEY ([PhotoId]) REFERENCES [Files].[ExternalFile] ([Id]);
