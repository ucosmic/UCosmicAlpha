...
namespace UCosmic.EntityFramework
{
    ...
    public class ActivityValuesOrm : RevisableEntityTypeConfiguration<ActivityValues>
    {
        public ActivityValuesOrm()
        {
            ...
            Property(p => p.Title).HasMaxLength(ActivityValuesConstraints.TitleMaxLength);
            ...
            Property(p => p.StartsFormat).HasColumnType("varchar").HasMaxLength(10);
            Property(p => p.EndsFormat).HasColumnType("varchar").HasMaxLength(10);
