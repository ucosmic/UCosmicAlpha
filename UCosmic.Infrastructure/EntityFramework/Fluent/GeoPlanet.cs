...
{
    public class GeoPlanetPlaceTypeOrm : EntityTypeConfiguration<GeoPlanetPlaceType>
    {
        public GeoPlanetPlaceTypeOrm()
        {
    ...
    public class GeoPlanetPlaceOrm : EntityTypeConfiguration<GeoPlanetPlace>
    {
        public GeoPlanetPlaceOrm()
        {
    ...
    public class GeoPlanetPlaceNodeOrm : EntityTypeConfiguration<GeoPlanetPlaceNode>
    {
        public GeoPlanetPlaceNodeOrm()
        {
    ...
    public class GeoPlanetPlaceBelongToOrm : EntityTypeConfiguration<GeoPlanetPlaceBelongTo>
    {
        public GeoPlanetPlaceBelongToOrm()
        {
